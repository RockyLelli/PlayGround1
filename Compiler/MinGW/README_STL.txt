...
Libraries:
    ...
    * GLFW 3.3.5
    * GLM 0.9.9.8
    * libjpeg-turbo 2.1.1 (with jpegtran)
    * libogg 1.3.5
    * libpng 1.6.37
    * libvorbis 1.3.7
    * PCRE 8.45 (with pcregrep)
    * PCRE2 10.37 (with pcre2grep)
    * SDL 2.0.16
    * SDL_mixer 2.0.4
    * zlib 1.2.11
    * zstd 1.5.0
...
Utilities:
    * coreutils 9.0 (only sort, uniq, and wc)
    * gdb 11.1
    * grep 3.7
    * LAME 3.100
    * make 4.3
...
[HISTORY]
18.0 - 10/30/2021 - GCC 11.2.0 - Boost 1.77.0 - Added: gh 2.2.0. Updated: binutils 2.37, Boost 1.77.0, coreutils 9.0,
...
17.1 - 12/11/2019 - GCC 9.2.0 - Boost 1.71.0 - Updated: git 2.24.1.2.
17.0 - 11/27/2019 - GCC 9.2.0 - Boost 1.71.0 - Added: GLFW 3.3. Updated: 7-Zip 19.00, binutils 2.33.1, Boost 1.71.0,
...
16.1 - 12/30/2018 - GCC 8.2.0 - Boost 1.69.0 - Added: OptiPNG 0.7.7, zstd 1.3.8. Removed: libbzip2, pngcrush. Updated:
...
16.0 -   7/4/2018 - GCC 8.1.0 - Boost 1.67.0 - Updated: 7-Zip 18.05, binutils 2.30, Boost 1.67.0, FreeType 2.9.1,
